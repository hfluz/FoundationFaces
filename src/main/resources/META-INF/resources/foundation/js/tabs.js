...
//      templateUrl: 'components/tabs/tabs.html',
      template: '<div><div class="tabs" ng-transclude></div><div zf-tab-content target="{{ id }}" ng-if="showTabContent"></div></div>',
...
//      templateUrl: 'components/tabs/tab-content.html',
      template: '<div class="tab-contents"><div zf-tab-individual class="tab-content" ng-class="{\'is-active\': tab.active}" ng-repeat="tab in tabs" tab="tab"></div></div>',
      link: link
    };
...
//      templateUrl: 'components/tabs/tab.html',
      template: '<div class="tab-item" ng-class="{\'is-active\': active}" ng-click="makeActive()">{{ title }}</div>',
      transclude: true,
      scope: {
        title: '@'
      },
